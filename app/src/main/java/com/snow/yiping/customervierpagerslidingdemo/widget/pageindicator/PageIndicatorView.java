package com.snow.yiping.customervierpagerslidingdemo.widget.pageindicator;
...
public class PageIndicatorView extends View implements ViewPager.OnPageChangeListener {
    ...
    private void initSizeAttribute(@NonNull TypedArray typedArray) {
        radiusPx = (int) typedArray.getDimension(R.styleable.PageIndicatorView_piv_radius, dpToPx(DEFAULT_RADIUS_DP));
        paddingPx = (int) typedArray.getDimension(R.styleable.PageIndicatorView_piv_padding, dpToPx(DEFAULT_PADDING_DP));
...
//        strokePx = (int) typedArray.getDimension(R.styleable.PageIndicatorView_piv_strokeWidth, dpToPx(FillAnimation.DEFAULT_STROKE_DP));
